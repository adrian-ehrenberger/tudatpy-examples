...
np.savetxt(os.path.join(this_file_path, "output", "radiation_pressure", "states_A.dat"), states_array)
np.savetxt(os.path.join(this_file_path, "output", "radiation_pressure", "dep_vars_A.dat"), dep_vars_array)
...
np.savetxt(os.path.join(this_file_path, "output", "radiation_pressure", "states_A_high_accuracy.dat"), states_array)
np.savetxt(os.path.join(this_file_path, "output", "radiation_pressure", "dep_vars_A_high_accuracy.dat"), dep_vars_array)