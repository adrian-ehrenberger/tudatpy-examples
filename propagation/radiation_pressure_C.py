...
panel_data = pd.read_csv(os.path.join(this_file_path, "input", "grail_macromodel.txt"), delimiter=", ", engine="python")
material_data = pd.read_csv(os.path.join(this_file_path, "input", "grail_materials.txt"), delimiter=", ", engine="python")
...
np.savetxt(os.path.join(this_file_path, "output", "radiation_pressure", "states_C.dat"), states_array)
np.savetxt(os.path.join(this_file_path, "output", "radiation_pressure", "dep_vars_C.dat"), dep_vars_array)
...
np.savetxt(os.path.join(this_file_path, "output", "radiation_pressure", "states_C_high_accuracy.dat"), states_array)
np.savetxt(os.path.join(this_file_path, "output", "radiation_pressure", "dep_vars_C_high_accuracy.dat"), dep_vars_array)
